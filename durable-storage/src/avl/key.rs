...
///
/// This mirrors [`MinimumPresence`] variant for variant, and is deliberately kept separate
/// from it: it records what a *comparison* did, which is what accumulates over the course of
/// proof generation, and leaves the translation into what the proof must carry to the one
/// place the key's leaf is folded.
