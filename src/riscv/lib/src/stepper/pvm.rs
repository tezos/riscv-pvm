...
impl<H, MC: MemoryConfig, BCC: BlockCacheConfig, M: ManagerReadWrite> PvmStepper<H, MC, BCC, M> {
    ...
    pub fn start_proof_mode<'a>(&'a self) -> PvmStepper<NoHooks, MC, BCC, ProofGen<Ref<'a, M>>> {
        PvmStepper::<NoHooks, MC, BCC, ProofGen<Ref<'a, M>>> {
    ...
    fn as_verify_stepper(
        ...
        PvmStepper<NoHooks, MC, BCC, Verifier, Interpreted<MC, Verifier>>,
