...
pub(crate) mod tests {
    ...
    backend_test!(test_region_overlap, F, {
        ...
        let mut array1: Cells<u64, LEN, F::Manager> = Cells::new();
        let mut array2: Cells<u64, LEN, F::Manager> = Cells::new();
    ...
    backend_test!(test_cell_overlap, F, {
        let mut cell1: Cell<[u64; 4], F::Manager> = Cell::new();
        let mut cell2: Cell<[u64; 4], F::Manager> = Cell::new();
    ...
    backend_test!(
        ...
        F,
        {
            ...
            let mut state = DynCells::<LEN, F::Manager>::new();
    ...
    backend_test!(test_dynregion_stored_format, F, {
        ...
        let mut region = DynCells::<1024, F::Manager>::new();
    ...
    backend_test!(test_region_stored_format, F, {
        // Writing to one item of the region must convert to stored format.
        let mut region = Cells::<Flipper, 4, F::Manager>::new();
