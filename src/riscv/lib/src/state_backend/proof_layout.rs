...
pub enum FromProofError {
    ...
    #[error("Expected a proof, but proof was absent")]
    AbsentProof,
...
pub trait ProofLayout: Layout {
    ...
    fn into_verifier_alloc<D: Deserialiser>(proof: D) -> ToVerifierAllocResult<D, Self>;
    ...
    AllocatedOf<B, Verifier>: 'static,
{
    ...
    fn into_verifier_alloc<De: Deserialiser>(proof: De) -> ToVerifierAllocResult<De, Self> {
