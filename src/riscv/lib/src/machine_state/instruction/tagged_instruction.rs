    ...
    fn from(value: Instruction) -> Self {
        let args = match opcode_to_argsshape(&value.opcode) {
            ArgsShape::XSrcXDest => TaggedArgs {
                rd: value.args.rd.x.into(),
                rs1: value.args.rs1.x.into(),
                rs2: value.args.rs2.x.into(),
                imm: value.args.imm,
                csr: value.args.csr,
                rs3f: value.args.rs3f,
                rm: value.args.rm,
            ...
            ArgsShape::FSrcFDest => TaggedArgs {
                rd: value.args.rd.f.into(),
                rs1: value.args.rs1.f.into(),
                rs2: value.args.rs2.f.into(),
                imm: value.args.imm,
                csr: value.args.csr,
                rs3f: value.args.rs3f,
                rm: value.args.rm,
            ...
            ArgsShape::NZXSrcNZXDest => TaggedArgs {
                rd: value.args.rd.nzx.into(),
                rs1: value.args.rs1.nzx.into(),
                rs2: value.args.rs2.nzx.into(),
                imm: value.args.imm,
                csr: value.args.csr,
                rs3f: value.args.rs3f,
                rm: value.args.rm,
...
pub fn opcode_to_argsshape(opcode: &OpCode) -> ArgsShape {
    ...
    match opcode {
        ...
        | X32AtomicLoad | X32AtomicStore | X32AtomicSwap | X32AtomicAdd | X32AtomicXor
        | X32AtomicAnd | X32AtomicOr | X32AtomicMinSigned | X32AtomicMaxSigned
        | X32AtomicMinUnsigned | X32AtomicMaxUnsigned | X64AtomicLoad | X64AtomicStore
        | X64AtomicSwap | X64AtomicAdd | X64AtomicXor | X64AtomicAnd | X64AtomicOr
