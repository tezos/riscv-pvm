...
pub fn opcode_to_argsshape(opcode: &OpCode) -> ArgsShape {
    ...
    match opcode {
        ...
        | X32AtomicAnd | X32AtomicOr | Amominw | Amomaxw | Amominuw | Amomaxuw | X64AtomicLoad
        | X64AtomicStore | X64AtomicSwap | X64AtomicAdd | X64AtomicXor | X64AtomicAnd
        | X64AtomicOr | X64AtomicMinSigned | X64AtomicMaxSigned | X64AtomicMinUnsigned
        | X64AtomicMaxUnsigned | X32Mul | Csrrw | Csrrs | Csrrc | Csrrwi | Csrrsi | Csrrci => {
            ArgsShape::XSrcXDest
        }
