...
all: riscv/all sandbox/all jstz/all dummy/all evm-poc/all page-cache-tester/all etherlink/all docs/all

check: riscv/check durable/check jstz/check dummy/check evm-poc/check dummy-no-std/check page-cache-tester/check etherlink/check assets/check docs/check check-format

build: sandbox/build jstz/build dummy/build evm-poc/build dummy-no-std/build page-cache-tester/build etherlink/build

clean: sandbox/clean jstz/clean dummy/clean evm-poc/clean page-cache-tester/clean etherlink/clean cargo-clean
...
evm-poc/%:
	@make -C kernels/evm-poc ${@:evm-poc/%=%}
