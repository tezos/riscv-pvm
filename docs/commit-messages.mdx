...
description: "Guidelines on Git commit messages"
---
...
[`.github/workflows/commitlint.yml`](https://github.com/tezos/riscv-pvm/blob/main/.github/workflows/commitlint.yml) on all pull requests.
