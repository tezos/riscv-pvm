...
Collection does not force that — reclamation follows the full-commit cadence rather than every round, because compacting the store costs the store rather than the garbage.
</Note>
