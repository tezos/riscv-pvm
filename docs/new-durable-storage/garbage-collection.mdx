...
### Deleting nodes: the sweep

The edges above are what the sweep walks; what it does with them is what is missing.

A stamp on an edge is the sequence number of the most recent root the child was proven reachable from.
